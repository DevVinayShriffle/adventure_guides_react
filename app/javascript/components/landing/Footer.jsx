      ...
      <div className="bg-stone-900 w-full mt-25 flex flex-col items-center justify-center gap-10 py-8 text-white">
        <div>
          <div className="flex justify-center items-center gap-2">
            <div className="border p-2 rounded-full"><p className="font-bold text-2xl">AG</p></div>

            <div className="flex gap-2"><span className="font-medium font-xl">ADVENTURE</span> <p className="font-light">Guides</p></div>
          </div>
        </div>
